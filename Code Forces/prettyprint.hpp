...
namespace pretty_print {
	...
	struct print_container_helper< T, TChar, TCharTraits, TDelimiters >::printer< std::pair< T1, T2 > > {
		...
		static void print_body (const std::pair< T1, T2 >& c, ostream_type& stream) {
			...
			if (print_container_helper< T, TChar, TCharTraits, TDelimiters >::delimiters_type::values
				.delimiter != NULL)
				stream << print_container_helper< T, TChar, TCharTraits, TDelimiters >::delimiters_type::values
						  .delimiter;
			stream << c.second;
		}
	};
	...
	struct print_container_helper< T, TChar, TCharTraits, TDelimiters >::printer< std::tuple< Args... > > {
		...
		static void
		tuple_print (const element_type& c,
					 ostream_type& stream,
	...
	delimiters< ::std::unordered_set< T, THash, TEqual, TAllocator >, wchar_t >::values = {L"{", L", ", L"}"};
...
namespace std {
	...
	inline
	typename enable_if< ::pretty_print::is_container< T >::value, basic_ostream< TChar, TCharTraits >& >::type
...
void debug (const T& t, const U& u, const ARGS&... args) {
	cout << t << ' ';
	debug (u, args...);
}
